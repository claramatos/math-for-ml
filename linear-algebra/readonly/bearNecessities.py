...
def draw_mirror(bear_vectors):
    ...
    ax.arrow(0, 0, bear_vectors[0, 0], bear_vectors[1, 0], lw=3, color=orange, zorder=5, head_width=0.1)
    ax.arrow(0, 0, bear_vectors[0, 1], bear_vectors[1, 1], lw=3, color=orange, zorder=5, head_width=0.1)
